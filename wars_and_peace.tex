...
\begin{enumerate}
  ...
  \item \textbf{Repatriate mobile forces.} Remove ships and Ground Units from
    ...
    Bases, Ship Yards, and Fleet Trains remain in place.
  ...
  \item \textbf{Build forces.} Spend remaining RU on any currently legal unit.
    ...
    Outposts cost only 2 RU during peace. Interwar production is not limited by
    Ship Yard capacity because it abstracts several years of construction.
    Place newly built Bases and Ship Yards on legal friendly Worlds; a newly
    built Ship Yard may be used for the following Redeploy step.
  \item \textbf{Redeploy.} The loser deploys all repatriated ships and Ground
    Units first, then the winner. Ships, Fighters, and Fleet Trains deploy in a
    system containing an operational friendly Ship Yard; Ship Yard capacity
    does not limit this redeployment. Ground Units may deploy at any friendly,
    unneutralized World or connected Outpost. Repair all surviving damage at
    no cost.
