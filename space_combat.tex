...
Fighters have a fixed Beam Package. Bases have a fixed Missile Package.
Carriers, Transports, and Fleet Trains have no package and cannot fire if their
printed Attack is zero.
...
A Base on a friendly surface in the system joins its owner's space battle. In
a binary system, every friendly Base may join. A Base is combat-capable, counts
for Fleet Size and screening, and cannot retreat. Ground Units and surfaces do
not otherwise participate in space combat.
...
Fleet Trains and Bases cannot be Pickets. Each player rolls a d10 and adds the
Picket's Maneuver Rating and friendly Tactics. The side with fewer
combat-capable non-Fighter ships also adds +1. The higher total chooses Long or
Close Range for the round. On a tie, range remains unchanged.
...
operational Fighters and Bases. The side with more may screen eligible groups
under \SpaceEmpires\ rule 5.7. Fleet Trains and other non-combat units are
screened automatically while a friendly combat-capable ship remains.
...
Bases, Fleet Trains, and other non-combat units cannot retreat.
