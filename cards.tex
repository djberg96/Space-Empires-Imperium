...
This variant adds a deck of cards (henceforth the Imperium Deck) that both players will use over the course of the game. These cards can affect movement, production and combat in various ways. Imperial Intervention and Appeals to the Emperor are also altered slightly for use with these cards.

This adds a bit of flavor and chaos to the game and, hopefully, makes the game a bit more interesting.
...
Cards may not be held between wars. Any cards still in your hand at the end of the final turn of the game must either be discarded for +3 RU each (available at the start of the next war), or used to automatically pay the maintenance cost of a ship instead of rolling, one card per ship.

\textit{Exception: you must discard 2 cards to automatically pay the maintenance of a Battleship.}
...
High Intensity Missile Fire is abbreviated as "HIMF". Short Range Missile Fire is abbreviated as "SRMF".
...
\textit{Requirement: Have at least 1 surviving ship at the end of the first round of combat.}
...
\textbfit{When: Combat (Bombardment)}
...
\textbfit{When: Immediately after Maintenance and Production}
...
\subsection{Imperial Intervention and Appeals to the Emperor}

\subsubsection{Imperial Intervention}

On a roll of "2" the Imperial player immediately loses one random card.

On a roll of "10" the Imperial player immediately draws a card.

\subsubsection{Appeals to the Emperor}

On a roll of "6" the Imperial player immediately draws a card.