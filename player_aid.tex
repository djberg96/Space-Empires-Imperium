...
B & Joint Logistics: politics, connections/supply/income, maintenance, cards,
arrivals, purchases. \\
...
Each operational Ship Yard at a connected World supplies one Hull Size point
when production arrives; yards combine only within a system. Ships, Fighters,
and Fleet Trains require capacity. Bases, Ground Units, Outposts, and new Ship
Yards do not. A new yard supplies capacity beginning next Game Turn.
...
\begin{enumerate}
  \item Reveal groups, packages, and technology. Friendly Bases and Ship Yards
    join.
  ...
  \item From round 2, a group may retreat instead of firing at its class.
    Bases, Ship Yards, and Fleet Trains cannot retreat.
\end{enumerate}
...
Ship Yard technology is not used; every yard has fixed level-1 capacity.
