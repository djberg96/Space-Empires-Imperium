...
retreat. Bases are not Ground Units and do not fire in ground combat.
...
\begin{itemize}
  \item \textbf{Outpost:} replace it with an attacker's Outpost. Destroy any
    Base on the surface.
  \item \textbf{World:} place a Neutralized marker. The World produces no RU,
    carries no connection, bases no Fighters, and creates no Militia.
