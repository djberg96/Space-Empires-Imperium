...
The separate Logistics \& Fleet Record aid provides an income and spending
ledger, Ship Yard capacity table, production track, and hidden Armament Package
manifest. Each player should keep one copy beside their RU and technology
tracks.
...
Fleet Trains, Bases, Ship Yards, and Ground Units do not. A Carrier and its
Fighters are maintained separately. Each unsupplied ship costs one additional
RU.
...
Each operational Ship Yard at a connected, friendly, unneutralized World
provides one Hull Size point of construction capacity during this step. Ship
Yards in the same system combine their capacity; capacity cannot be combined
between systems.

Each arriving ship, Fighter, or Fleet Train must be placed in a system with
enough unused Ship Yard capacity and consumes capacity equal to its printed
Hull Size, with a minimum of one. A Base or Ground Unit appears on any
friendly, unneutralized World and uses no Ship Yard capacity. An Outpost
appears in the owner's unplaced pool and must be transported to its
destination.

A completed Ship Yard may be placed on a connected, friendly, unneutralized
primary World and uses no construction capacity. No more than one new Ship
Yard may be placed on the same World during a single Completed Production
step. A Ship Yard that arrives during this step provides no capacity until the
next Game Turn.

The owner chooses the order in which completed units use capacity. If no legal
arrival location or sufficient capacity exists, delay that unit to the next
Game Turn. A delayed unit is not lost if the war ends; it carries into the
peace process.
...
\begin{itemize}
  \item Ground Units, Fighters, Transports, Scouts, Destroyers, Cruisers,
    Carriers, Bases, Ship Yards, Fleet Trains, and Outposts arrive next Game
    Turn.
...
\subsection{Ship Yards}

A Ship Yard represents the orbital docks and industrial infrastructure needed
to construct starships. It uses its printed combat values and a fixed Beam
Package. It is combat-capable but cannot move, react, serve as a Picket, or
retreat. It costs no maintenance.

Ship Yards cost their printed \SpaceEmpires\ price. They are built by a World,
not by another Ship Yard, and therefore do not consume construction capacity.
A primary World may contain more than one Ship Yard, although only one new
Ship Yard may arrive there in a particular Game Turn.
