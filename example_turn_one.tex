...
Shuruppak, with its remaining units elsewhere on its connected network. Terra
has one Ship Yard at each of its three Worlds; the Imperium has one at each of
its four Worlds. No Base, Ship Yard, or Ground Unit is at Shuruppak. All
starting ships are supplied.
...
Maintenance equals Hull Size. Bases, Ship Yards, Ground Units, and Fleet
Trains are free. All ships are supplied, so there is no surcharge.
...
Ship Yard capacity is checked when production arrives, not when it is bought.
On Game Turn 2, Terra can place the Hull-1 Destroyer at one Terran Ship Yard
and the Hull-1 Fleet Train at another; the Outpost requires no capacity and
enters the unplaced pool. The Imperial Hull-1 Destroyer can use any one of the
four Imperial Ship Yards. A single starting yard could not receive a Hull-2
Cruiser; two yards would first have to be concentrated in the same system.
...
Completed Production. The ships and Fleet Train must be allocated to Ship
Yards with enough construction capacity.
...
\begin{itemize}
  ...
  \item Each Ship Yard supplies one Hull Size point when completed production
    arrives. Capacity combines within a system, not across the map.
