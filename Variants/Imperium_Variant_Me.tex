...
During the preparation step of combat you may "attach" a scout to another ship during placement. Place the scout and the ship that it's attached to at the same time. The scout is considered to be providing electronic support (ECM) to the attached ship. Enemy ships firing at a ship with an attached scout suffer a -1 penalty to the die roll. This applies to both beam and missile combat.
