...
\begin{enumerate}
  ...
  \item Lay out the \Imperium\ map. Place Worlds, Outposts, Bases, Ship Yards,
    fleets, and Ground Units listed by the scenario. Put Ground Units, Bases,
    and Ship Yards in their surface box; all other starting units begin in the
    stellar hex.
  \item Record each side's starting technology and capital-construction level,
    and record an Armament Package for every eligible ship group on that
    side's Logistics \& Fleet Record aid. Technology applies to every eligible
    friendly group.
...
Unless a scenario says otherwise, place one Ship Yard on every primary
surface containing a starting World. A World created or captured during play
does not receive a free Ship Yard.
